...
config.set(
    ...
    True,
    "file:///home/kek/.local/share/qutebrowser/userscripts/*",
)
...
# qutebrowser`.
# Type: Dict
c.url.searchengines = {"DEFAULT": "https://searx.syscat.org/?q={}"}
...
c.hints.selectors["all"].append('div[class="Collapsible"]')
c.hints.selectors["all"].append("li[data-category-value]")
c.hints.selectors["all"].append("li[data-type]")
c.hints.selectors["all"].append('span[class="plus"]')
c.hints.selectors["all"].append('span[class="zoom-icon"]')
# c.hints.selectors['all'].append("a[href=\"#\"]")
c.hints.selectors["all"].append('div[class="filter-type__title"]')
c.hints.selectors["all"].append('span[class=" filter-option "]')
c.hints.selectors["all"].append(
